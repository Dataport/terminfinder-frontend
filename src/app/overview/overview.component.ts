...
export class OverviewComponent implements OnInit {
  ...
  isAppointmentSent() {
    ...
    return (
      !NullableUtils.isStringNullOrWhitespace(apiAppointment.appointmentId) &&
      !NullableUtils.isStringNullOrWhitespace(apiAppointment.adminId)
    );
  }
  ...
  sendCreateAppointment(): void {
    ...
    this.dataRepoService
      .createAppointment(apiAppointment)
  ...
  sendUpdateAppointment(): void {
    ...
    this.dataRepoService
      .updateAppointmentAndDeleteSuggestedDates(apiAppointment, apiSuggestedDatesToDelete)
      .then((data: ApiAppointment) => {
        this.model = ModelTransformerService.transformApiAppointmentToAppointment(data);
        this.appStateService.updateAppointment(this.model);
        this.apiError = null;
        ...
        this.logger.debug(
          `Terminvorschlag/Terminvorschläge lösche mit den Werten: ${JSON.stringify(apiSuggestedDatesToDelete)}`
        );
