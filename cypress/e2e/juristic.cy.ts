...
context('juristic', () => {
  ...
  describe('Juristic sites are working', () => {
    ...
    it('Imprint is working', () => {
      cy.get('[data-cy=imprintLink]').click();
      cy.url().should('include', '/#/imprint');

      cy.get('[data-cy=imprintHeadline]');
      cy.get('[data-cy=content]').should('not.have.html', '');
    ...
    it('Accessibility is working', () => {
      cy.get('[data-cy=accessibilityLink]').click();
    ...
    it('Privacy is working', () => {
      cy.get('[data-cy=privacyLink]').click();
    ...
    it('TOS Privacy is working', () => {
      cy.get('[data-cy=tosPrivacyLink]').click();
      cy.url().should('include', '/#/privacy');
